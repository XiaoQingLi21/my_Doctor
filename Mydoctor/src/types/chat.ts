...
export interface Messagenew {
  role: string;
  content: string;
  section_text?: string;  // Add this line if your objects have a 'section_text' property
}

export interface Messagenew1 {
  role: Role | string;  // Allow both specific roles and generic strings
  content: string;
}  

export interface Messagenew2 {
