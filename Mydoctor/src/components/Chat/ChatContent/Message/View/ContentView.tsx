...
const ContentView = memo(
  ({
    ...
    const chat = useStore((state) => state.chats ? state.chats[currentChatIndex] : null);
    ...
    return (
      <>
        ...
        <div className='flex justify-end gap-2 w-full mt-2'>
          ...
          {messageIndex !== lastMessageIndex && <DownButton onClick={handleMoveUp} />}
          <MarkdownModeButton />
          <CopyButton onClick={handleCopy} />
          {/* EditButton and DeleteButton have been removed */}
        </div>
      </>
